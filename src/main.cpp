...
int64 nChainStartTime = 1460394865;
...
const string strMessageMagic = "HoldCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, const CBlockIndex* pindex)
{
     ...
     if (nPoWHeight < 80)
       nSubsidy = 525000 * COIN; //Premin: 124862016
	 else if(nPoWHeight < 78000000)
       nSubsidy = 2.5 * COIN;        //POW:5.9M
     else
       nSubsidy = 0 * COIN;
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    if(nHeight > YEARLY_POS_BLOCK_COUNT * 15)
      nSubsidy = 0;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in HoldCoin
    bool fStrictPayToScriptHash = true; // Always active in HoldCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HoldCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "bitcoin make bitfinex 2016/01/31 22:04 UTC+8, CHECK THIS!";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x98f64bb447f91bbaa1adbc52dc11b6c639714fe5f767f29ca75e9014eac26171"));
